...
import { calculateCarbohydrate, formatCarbohydrate } from './lib/carbs'
...
function App() {
  ...
  const addMeal = () => {
    if (!selectedFood || amount <= 0 || selectedFood.availableCarbs100g === null) return
    const carbs = calculateCarbohydrate(amount, selectedFood.availableCarbs100g)
...
function AddMealSheet({ query, setQuery, selectedFood, setSelectedFood, amount, setAmount, onClose, onAdd }: { query: string; setQuery: (value: string) => void; selectedFood: Food | null; setSelectedFood: (food: Food | null) => void; amount: number; setAmount: (value: number) => void; onClose: () => void; onAdd: () => void }) {
  ...
  const carbs = selectedFood?.availableCarbs100g !== null && selectedFood?.availableCarbs100g !== undefined ? calculateCarbohydrate(amount, selectedFood.availableCarbs100g) : 0
